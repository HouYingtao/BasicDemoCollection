...
public class QRCodeUtil {
    ...
    private static final int BLUE = 0xFF023E58;
...
//             MatrixToImageWriter.writeToPath(bitMatrix, format, outputPath);
            MatrixToImageConfig config = new MatrixToImageConfig(BLACK, BLUE);
//            MatrixToImageConfig config = new MatrixToImageConfig(BLACK, WHITE);
            MatrixToImageWriter.writeToPath(bitMatrix, format, outputPath, config);
        } catch (Exception e) {
